function makeResponsive() {
  ...
  // // Append an SVG group
  // var IndicatorGroup = svg.append("g")
   ...
   // append indicator y axis
    ...
    ilabelsGroup.selectAll("text").on("click", function() {
      ...
      if (valuei !== chosenIaxis) {
        ...
        indicatorline = svg.select("indicatorL");
        ...
        for (i = 1; i < volume.length; i++) {  // main loop to create each chart item 
          ...
          // console.log(indicator_win_height);
          // console.log(candle_win_height);
          console.log(chosenIaxis);
          // console.log(i);
          // console.log(min_i);
          // console.log(i_scaler);
