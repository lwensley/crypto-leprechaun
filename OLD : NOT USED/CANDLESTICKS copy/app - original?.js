function makeResponsive() {
 ...
 // const left_margin = 50;
  ...
  for (i = 1; i < volume.length; i++) {  // main loop to create each chart item 
    ...
    .attr("y1", indicator_win_height+candle_win_height-(indicator_1[i-1]-min_i1)*i1_scaler+margin.top) //y pos for previous 
    .attr("y2", indicator_win_height+candle_win_height-(indicator_1[i]-min_i1)*i1_scaler+margin.top) // y pos for current 
    .style("stroke", "blue")
    .style("stroke-width", "2")
    .style("fill", "none");
    ...
    .attr("x1", bar_width*(i-1)+margin.left) //previous line x pos 
    .attr("x2", bar_width*i+margin.left) // current line xpos
    .attr("y1", (margin.top+candle_win_height+indicator_win_height)-((indicator_2[i-1]-min_i2)*i2_scaler)) //y pos for previous 
    .attr("y2", (margin.top+candle_win_height+indicator_win_height)-((indicator_2[i]-min_i2)*i2_scaler)) // y pos for current 
    .style("stroke", "green ")
    .style("stroke-width", "2")
    .style("fill", "none");
